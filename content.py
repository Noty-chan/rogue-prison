...
CARDS += [
    _c("ARCANE_JAB", "Арканный тычок", "common", "attack", 1, "enemy",
       ...
       [{"op":"damage","amount":6}],
       tags=["burst"],
       desc_up="Нанеси 8 урона. (Крит 15%)",
       effects_up=[{"op":"damage","amount":8}]),
    _c("RUNE_SLASH", "Рунический разрез", "common", "attack", 1, "enemy",
       ...
       tags=["bleed"],
       desc_up="Нанеси 7 урона. Наложи 2 Кровоток.",
       effects_up=[{"op":"damage","amount":7},{"op":"apply","status":"bleed","stacks":2,"to":"enemy"}]),
    _c("SPARK_SHOT", "Искра", "common", "attack", 0, "enemy",
       "Нанеси 3 урона.",
       [{"op":"damage","amount":3}],
       tags=["burst"],
       desc_up="Нанеси 5 урона.",
       effects_up=[{"op":"damage","amount":5}]),
    _c("SHACKLED_STRIKE", "Удар в кандалах", "common", "attack", 1, "enemy",
       ...
       tags=["control"],
       desc_up="Нанеси 6 урона. Наложи 2 Слабость.",
       effects_up=[{"op":"damage","amount":6},{"op":"apply","status":"weak","stacks":2,"to":"enemy"}]),
    _c("PRISON_SHIV", "Тюремная заточка", "common", "attack", 1, "enemy",
       ...
       tags=["crit","burst"],
       desc_up="Нанеси 8 урона. Если это был крит — возьми 2 карты.",
       effects_up=[{"op":"damage","amount":8,"on_crit":[{"op":"draw","n":2}]}]),
    _c("GUARD_SIGIL", "Сигил стражи", "common", "defense", 1, "self",
       "Получишь 6 Блока.",
       [{"op":"block","amount":6}],
       tags=["block"],
       desc_up="Получишь 8 Блока.",
       effects_up=[{"op":"block","amount":8}]),
    _c("STONE_SKIN", "Каменная кожа", "common", "defense", 1, "self",
       ...
       tags=["block"],
       desc_up="Получишь 7 Блока. Получишь 2 Шипа.",
       effects_up=[{"op":"block","amount":7},{"op":"apply","status":"thorns","stacks":2,"to":"self"}]),
    _c("SIDESTEP_GLYPH", "Глиф уклонения", "common", "defense", 0, "self",
       "Получишь 3 Блока.",
       [{"op":"block","amount":3}],
       tags=["block"],
       desc_up="Получишь 5 Блока.",
       effects_up=[{"op":"block","amount":5}]),
    _c("FOCUS", "Фокус", "common", "skill", 1, "none",
       "Возьми 2 карты, затем сбрось 1 карту на выбор.",
       [{"op":"draw","n":2},{"op":"discard_choose","n":1}],
       tags=["discard"],
       desc_up="Возьми 3 карты, затем сбрось 1 карту на выбор.",
       effects_up=[{"op":"draw","n":3},{"op":"discard_choose","n":1}]),
    _c("SOUL_SIP", "Глоток души", "common", "skill", 1, "self",
       "Исцелись на 3. Потрать 1 ману.",
       [{"op":"heal","amount":3}],
       tags=[],
       desc_up="Исцелись на 5. Потрать 1 ману.",
       effects_up=[{"op":"heal","amount":5}]),
    _c("MANA_DRIP", "Капля маны", "common", "skill", 0, "self",
       "Получи +1 маны.",
       [{"op":"gain_mana","n":1}],
       tags=["mana"],
       desc_up="Получи +1 маны и возьми 1 карту.",
       effects_up=[{"op":"gain_mana","n":1},{"op":"draw","n":1}]),
    _c("CHAIN_PULL", "Рывок цепью", "common", "skill", 1, "enemy",
       "Наложи 2 Уязвимость.",
       [{"op":"apply","status":"vulnerable","stacks":2,"to":"enemy"}],
       tags=["control"],
       desc_up="Наложи 3 Уязвимость.",
       effects_up=[{"op":"apply","status":"vulnerable","stacks":3,"to":"enemy"}]),
    _c("TOXIC_NEEDLE", "Токсичная игла", "common", "attack", 1, "enemy",
       ...
       tags=["poison"],
       desc_up="Нанеси 4 урона. Наложи 4 Яд.",
       effects_up=[{"op":"damage","amount":4},{"op":"apply","status":"poison","stacks":4,"to":"enemy"}]),
    _c("ASH_FLICK", "Щелчок пеплом", "common", "skill", 1, "enemy",
       "Наложи 4 Ожог.",
       [{"op":"apply","status":"burn","stacks":4,"to":"enemy"}],
       tags=["burn"],
       desc_up="Наложи 6 Ожог.",
       effects_up=[{"op":"apply","status":"burn","stacks":6,"to":"enemy"}]),
    _c("SHACKLES", "Оковы", "common", "skill", 1, "enemy",
       "Наложи 2 Слабость.",
       [{"op":"apply","status":"weak","stacks":2,"to":"enemy"}],
       tags=["control"],
       desc_up="Наложи 3 Слабость.",
       effects_up=[{"op":"apply","status":"weak","stacks":3,"to":"enemy"}]),
    ...
    _c("SCAVENGE", "Сортировка мусора", "common", "skill", 1, "none",
       ...
       tags=["discard","mana"],
       desc_up="0: Сбрось 1 карту. Получи +2 маны и возьми 1 карту.",
       cost_up=0,
       effects_up=[{"op":"discard_choose","n":1},{"op":"gain_mana","n":2},{"op":"draw","n":1}]),
    _c("TRASH_TO_TREASURE", "Мусор в золото", "common", "skill", 1, "none",
       ...
       tags=["discard"],
       desc_up="Сбрось 1 случайную карту. Возьми 3 карты.",
       effects_up=[{"op":"discard_random","n":1},{"op":"draw","n":3}]),
    ...
    _c("VENOM_DAGGER", "Ядовитый кинжал", "common", "attack", 1, "enemy",
       ...
       tags=["poison","burst"],
       desc_up="Нанеси 7 урона. Наложи 3 Яд.",
       effects_up=[{"op":"damage","amount":7},{"op":"apply","status":"poison","stacks":3,"to":"enemy"}]),
    _c("GLIMMER_SHIELD", "Мерцающий щит", "common", "defense", 1, "self",
       ...
       tags=["block"],
       desc_up="Получишь 9 Блока. До конца этого хода отражаешь весь урон.",
       effects_up=[{"op":"block","amount":9},{"op":"add_buff","buff":"reflect_full_1turn"}]),
    _c("SCRAP_TRADE", "Сделка за мусор", "common", "skill", 0, "none",
       "Потеряй 2 HP. Возьми 2 карты.",
       [{"op":"lose_hp","amount":2},{"op":"draw","n":2}],
       tags=["discard","burst"],
       desc_up="Потеряй 1 HP. Возьми 3 карты.",
       effects_up=[{"op":"lose_hp","amount":1},{"op":"draw","n":3}]),
    _c("CHAINS_REBOUND", "Отскок цепей", "common", "attack", 1, "enemy",
       ...
       tags=["discard","burst"],
       desc_up="Нанеси 8 урона. Если в руке есть карта со сбросом — получи 5 Блока.",
       effects_up=[{"op":"damage","amount":8},{"op":"if_hand_has_tag","tag":"discard","then":[{"op":"block","amount":5}]}]),
]
...
CARDS += [
    ...
    _c("BURNING_CHAINS", "Горящие цепи", "uncommon", "attack", 1, "enemy",
       ...
       tags=["burn","control"],
       desc_up="Нанеси 6 урона. Наложи 4 Ожога и 2 Слабость.",
       effects_up=[{"op":"damage","amount":6},{"op":"apply","status":"burn","stacks":4,"to":"enemy"},{"op":"apply","status":"weak","stacks":2,"to":"enemy"}]),
    ...
    _c("RECYCLE", "Переработка", "uncommon", "skill", 0, "none",
       ...
       tags=["discard"],
       desc_up="Возьми карту из сброса и уменьши её стоимость на 1 (мин. 0) до конца боя.",
       effects_up=[{"op":"take_from_discard","n":1,"reduce_cost":1}]),
    ...
    _c("MIRROR_SHARD", "Осколок зеркала", "uncommon", "skill", 1, "none",
       ...
       tags=["burst"],
       desc_up="(0) Следующая сыгранная атака повторяется на 50% силы.",
       cost_up=0,
       effects_up=[{"op":"add_buff","buff":"echo_attack_half"}]),
    _c("BARGAIN_WARDEN", "Сделка с надзирателем", "uncommon", "skill", 1, "self",
       ...
       tags=["mana"],
       desc_up="Получи 3 Макс.Маны до конца боя. Потеряй 2 HP.",
       effects_up=[{"op":"lose_hp","amount":2},{"op":"gain_max_mana","n":3,"duration":"combat"}]),
    _c("PANIC_ROLL", "Панический кувырок", "uncommon", "skill", 0, "none",
       ...
       tags=["discard","block"],
       desc_up="Получишь 4 Блока. Возьми 2 карты. Сбрось 1 карту.",
       effects_up=[{"op":"block","amount":4},{"op":"draw","n":2},{"op":"discard_choose","n":1}]),
    ...
    _c("NEEDLE_RAIN", "Дождь игл", "uncommon", "skill", 1, "all_enemies",
       ...
       desc_up="Нанеси 5 урона всем. Бонус +4 при яде/кровотоке.",
       effects_up=[{"op":"aoe_damage","amount":5,"bonus_if_has_any_status":["poison","bleed"],"bonus":4}]),
    _c("MIRROR_STANCE", "Зеркальная стойка", "uncommon", "skill", 1, "self",
       ...
       tags=["block","discard"],
       desc_up="Получишь 8 Блока. Следующая карта вернётся в руку. Возьми 1 карту.",
       effects_up=[{"op":"block","amount":8},{"op":"add_buff","buff":"bounce_next"},{"op":"draw","n":1}]),
    _c("VENOMOUS_WAVE", "Ядовитая волна", "uncommon", "skill", 1, "all_enemies",
       ...
       tags=["poison","control"],
       desc_up="Наложи 5 Яд всем врагам. Получи 6 Блока.",
       effects_up=[{"op":"apply","status":"poison","stacks":5,"to":"all_enemies"},{"op":"block","amount":6}]),
]
...
CARDS += [
    ...
    _c("PLAGUE_DOCTRINE", "Доктрина чумы", "rare", "upgrade", 1, "self",
       ...
       tags=["poison"],
       exhaust=True,
       desc_up="Изгнание. Яд не уменьшается и в конце твоего хода все враги получают 1 Яд.",
       effects_up=[{"op":"add_buff","buff":"poison_no_decay"},{"op":"apply","status":"poison","stacks":1,"to":"all_enemies"}]),
    _c("INFERNO_CONTRACT", "Адский контракт", "rare", "upgrade", 1, "self",
       ...
       tags=["burn"],
       exhaust=True,
       desc_up="Изгнание. Ожог сильнее, не уменьшается в ход врага и в конце хода накладывай 1 Ожог всем врагам.",
       effects_up=[{"op":"add_buff","buff":"burn_boost"},{"op":"apply","status":"burn","stacks":1,"to":"all_enemies"}]),
    ...
    _c("WARD_OF_MIRRORS", "Зеркальный барьер", "rare", "defense", 2, "self",
       ...
       tags=["block"],
       desc_up="Получишь 18 Блока. До конца хода отражаешь весь урон.",
       effects_up=[{"op":"block","amount":18},{"op":"add_buff","buff":"reflect_full_1turn"}]),
    ...
    _c("MIRROR_REPRISAL", "Зеркальный отпор", "rare", "defense", 2, "self",
       ...
       tags=["block","control"],
       desc_up="Получишь 14 Блока. В этот ход отражаешь весь полученный урон.",
       effects_up=[{"op":"block","amount":14},{"op":"add_buff","buff":"reflect_full_1turn"}]),
    _c("PLAGUE_SPRING", "Чумной источник", "rare", "skill", 2, "all_enemies",
       ...
       tags=["poison","heal"],
       desc_up="Наложи 6 Яд всем врагам. Исцелись на 3 за каждого врага.",
       effects_up=[{"op":"apply","status":"poison","stacks":6,"to":"all_enemies"},{"op":"heal_per_enemy","amount":3}]),
]
...
CARDS += [
    _c("CRIT_OF_DAMNED", "Крит проклятых", "legendary", "upgrade", 1, "self",
       ...
       tags=["crit"],
       exhaust=True,
       desc_up="Изгнание. +25% шанс крита, криты x3. Возьми 2 карты.",
       effects_up=[{"op":"add_buff","buff":"crit_godmode"},{"op":"draw","n":2}]),
    ...
    _c("WARDENS_KEY", "Ключ надзирателя", "legendary", "skill", 0, "none",
       ...
       tags=["mana","block"],
       desc_up="Выбери: (1) +3 маны, (2) возьми 4 карты, (3) получи 12 Блока.",
       effects_up=[{"op":"choose_one","options":[
           {"label":"+3 маны","effects":[{"op":"gain_mana","n":3}]},
           {"label":"Возьми 4","effects":[{"op":"draw","n":4}]},
           {"label":"12 Блока","effects":[{"op":"block","amount":12}]},
       ]}]),
