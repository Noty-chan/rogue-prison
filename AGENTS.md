...
Критичность: **Major** — **ИСПРАВЛЕНО (2025-07-09)**
Результат: победа теперь триггерится даже когда враги умирают от яда/ожога в свой ход, поэтому награда гарантированно выдаётся.
...
- [x] A5. Победы от DoT/реактивов выдают награду и переводят на карту (2025-07-09)
- [x] A6. Блок врагов сбрасывается в начале их хода и защищает от атак игрока (2025-12-15)
- [x] A7. Победа срабатывает сразу при гибели всех врагов, даже если они умирают в свой ход (2025-12-15)
- [x] A8. Пропуски ходов от контроля синхронизированы для игрока и врагов (2025-07-19)
- [+] A9. «Сортировка мусора» снова даёт ману после сброса выбранной карты (2026-02-06)
...
- [+] B7. Блок врагов и игрока отображается в статусной панели боя (2025-12-15)
- [+] B8. Настройки подключения: быстрые кнопки базы API + список LAN-адресов (2025-02-06)


### Этап C — Контент и билдостроение
- [ ] C1. Довести пул карт до стабильного баланса (особенно legendary)
  - [+] Добавлены улучшения описаний/стоимости для базовых карт наград и костра (2025-12-16)
  - [+] Починен флоу карт со сбросом: эффекты после выбора сброса применяются корректно (мана/добор) (2025-12-17)
  - [+] Апгрейды карт применяют все заявленные поля и не ломают исходные описания (2025-12-17)
- [x] C2. Увеличить разнообразие событий (ирония/мрак) — добавлена проклятая камера с реликвией/очищением (2025-07-05)
- [ ] C3. Расширить пул врагов и боссов, уникальные паттерны
  ...
  - [+] Добавлено направление исцеления и 10 карт поддержки (2025-12-14)
  - [+] Добавлено 10 карт для ядов/сброса/блока и легендарная призма яда (2025-07-01)
  - [+] Расширены события до 10 шт. и добавлены комнатные твисты 50% (2025-07-01)
  - [+] Боссы и элиты получили фазовые переходы/контратаки и телеграфы на этажах 4/8/10 (2025-07-13)
...
- [x] E1. Реликвии/артефакты — базовый пул реликвий и сундуки, выдающие артефакты (2025-07-05)
- [x] E2. Проклятья/нагрузка колоды — три проклятья, награды событий/сундуков (2025-07-05)
- [ ] E3. Эндлесс‑скейлинг (четкий рост сложности, награды, рекорды)

### Этап F — Мобильность и GitHub Pages
- [x] F1. Адаптивные макеты HUD/карт/оверлеев для телефонов, фиксированные панели и безопасные отступы (2025-07-06)
- [x] F2. Баннер потери связи + настройка базы API для развёртывания на GitHub Pages и внешних доменах (2025-07-06)
- [ ] F3. Улучшить тач-драг карт и жесты скролла на карте (предстоит)
- [+] F4. Резервный API и автопереключение при потере связи (2025-02-06)
